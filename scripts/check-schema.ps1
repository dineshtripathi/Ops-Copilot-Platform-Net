...
$connStr = "Server=tcp:sql-opscopilot-platform-dev-uks.database.windows.net,1433;Database=sqldb-opscopilot-platform-dev;User ID=opsadmin;Password=Transview@73AITest;Encrypt=true;TrustServerCertificate=false;Connection Timeout=30;"
