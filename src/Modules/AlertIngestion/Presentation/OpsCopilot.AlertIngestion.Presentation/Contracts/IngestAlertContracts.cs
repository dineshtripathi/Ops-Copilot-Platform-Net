...
/// <c>true</c> when a downstream triage dispatcher was triggered;
/// <c>false</c> when no real dispatcher is configured (default).
/// </param>
public sealed record IngestAlertResponse(Guid RunId, string Fingerprint, bool Dispatched = false);
